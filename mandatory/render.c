...
/*   Updated: 2024/10/29 12:39:05 by kahmada          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_img *get_texture(t_player *player, int ray_id)
{
    ...
    if (texture_index == 0) return &player->no_img;
    else if (texture_index == 1) return &player->so_img;
    else if (texture_index == 2) return &player->ea_img;
    else return &player->we_img;
}
